...
CREATE TABLE entries(content_id serial primary key, entry_id integer, created_at timestamp, version_number integer, entry_title varchar(100), entry_body text);

CREATE TABLE contents (entry_id serial primary key, author_id integer, created_at timestamp, version_number integer);
